...
add wave -noupdate /tb/mips_processor/instruction_IF
add wave -noupdate -divider Regfile
add wave -noupdate /tb/mips_processor/RegFile/register
...
add wave -noupdate -color Cyan -radix unsigned /tb/mips_processor/pc_ID
add wave -noupdate -color Cyan /tb/mips_processor/instruction_ID
...
add wave -noupdate /tb/mips_processor/read_data1_ID
add wave -noupdate -radix decimal /tb/mips_processor/read_data2_ID
...
add wave -noupdate /tb/mips_processor/stall
add wave -noupdate /tb/mips_processor/Asrc
add wave -noupdate /tb/mips_processor/Bsrc
add wave -noupdate -divider {stall controller}
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/rs_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/rt_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/MemRead_EX_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/MemRead_MEM_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/write_reg_EX_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/write_reg_MEM_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/RegWrite_EX_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/RegWrite_MEM_i
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/stall_o
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/Asrc_o
add wave -noupdate -color Magenta /tb/mips_processor/stall_controller/Bsrc_o
...
WaveRestoreCursors {{Cursor 1} {1371 ns} 0}
...
update
WaveRestoreZoom {1333 ns} {1409 ns}
